        ...
        methods: {
            localFuncCall(action) {
                switch(action.id) {
                    ...
                    // case 10: this.showBrokenMeters(action); break
                }
            },

            // showBrokenMeters(action) {
            //     this.actions = this.actions.map(a => {
            //         if (a.id !== 10 && a.id !== 8) return {...a, disabled: action.show}
            //         if (a.id === 10) return {...a, show: !a.show}
            //         return a
            //     })
            //     this.$emit('showBrokenMeters')
            // },
